...
<main id="main" class="site-main" role="main">
    <section id="hero" class="block">
        <div class="content">
            ...
            <p>Gestionamos crisis de alto perfil, control de daños y protección reputacional. Te acompañamos hasta
                recuperar el control de la narrativa.</p>
    ...
    <section id="metodology" class="block">
        ...
        <div class="content title-wrapper--cta">
            ...
            <h3 class="subtitle-section">Si tu credibilidad está en riesgo o enfrentas una situación pública adversa,
                necesitas una defensa estratégica inmediata. Protegemos tu legado con discreción y firmeza.</h3>
            <div class="cta-buttons">
                <button class="btn"><?= stories_get_icon('phone'); ?>Es una emergencia</button>
                <button class="btn hollow">Diagnóstico confidencial</button>
            </div>
    ...
    <section id="how-works" class="block">
        <div class="content">
            <div class="text">
                ...
                <h3 class="subtitle-section">Nuestro equipo está formado por ex-directores de medios, abogados
                    penalistas y expertos en ciberinteligencia. Hemos gestionado crisis para CEOs de Fortune 500,
                    figuras políticas y celebridades de alto nivel.</h3>
                <div class="container">
                    <div class="card">
    ...
    <section id="privacy" class="block">
        <div class="content">
            ...
            <p>Entendemos que lo más valioso en este momento es la discreción. Utilizamos canales de comunicación
                encriptados de grado militar desde el primer contacto. Nadie sabrá que nos contrataste, solo verán los
                resultados.</p>
        </div>
    </section>
    <section id="cases" class="block">
        <div class="content title-wrapper--cases">
            ...
            <h3 class="subtitle-section">Sabemos qué hacer porque lo hemos hecho antes. Entendemos la presión, la
                urgencia y la necesidad de actuar con precisión.</h3>
        </div>
        <div class="content cases">
            ...
            <div class="card purple">
                ...
                <p>conflictos laborales, huelgas o despidos masivos que saltan a la esfera pública. Gestionamos la
                    comunicación interna y externa simultáneamente.</p>
            </div>
        </div>
    </section>
    <section id="why-us" class="block">
        <div class="content slideshow-wrapper">
            ...
            <div class="navigation">
                <button id="related-products--backward-button"
                    class="slide-prev btn-pagination small-pagination"><?= stories_get_icon('backward'); ?></button>
                <div class="related-bullets"></div>
                <button id="related-products--forward-button"
                    class="slide-next btn-pagination small-pagination"><?= stories_get_icon('forward'); ?></button>
            </div>
        </div>
    </section>
    ...
    <section id="blog" class="block">
        <div class="content">
            <div class="heading">
                ...
                <h2 class="title-section">Inteligencia Reputacional: Lo que necesitas saber antes, durante y después
                    de una crisis</h2>
                <h3 class="subtitle-section">Nuestra visión, análisis y metodologías para entender cómo se construye
                    —y se destruye— una reputación en la era digital.</h3>
            </div>
            <div class="posts">
                <?php
                $args = [
            ...
            <button onclick="window.location.href='<?php echo site_url(); ?>/blog'" class="btn primary go-to-blog"
                aria-label="Link to go blog page">
    ...
    <section id="special" class="block posts--body">
        <div class="content special--heading">
